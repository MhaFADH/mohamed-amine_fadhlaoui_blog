...
export const postContentValidator = string().min(8).required()
export const postTitleValidator = string().min(3).required()
...
export const commentValidator = string().min(3).required()
